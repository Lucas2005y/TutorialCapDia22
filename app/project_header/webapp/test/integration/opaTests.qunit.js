sap.ui.require(
    [
        ...
        'projectheader/test/integration/FirstJourney',
		'projectheader/test/integration/pages/Interactions_HeaderList',
		'projectheader/test/integration/pages/Interactions_HeaderObjectPage',
		'projectheader/test/integration/pages/Interactions_ItemsObjectPage'
    ],
    function(JourneyRunner, opaJourney, Interactions_HeaderList, Interactions_HeaderObjectPage, Interactions_ItemsObjectPage) {
        ...
        var JourneyRunner = new JourneyRunner({
            ...
            launchUrl: sap.ui.require.toUrl('projectheader') + '/index.html'
        });
